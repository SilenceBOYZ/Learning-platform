  ...
  return (
    <form className="px-6 py-6 bg-slate-100 w-[30rem] max-w-[30rem] space-y-6">
      ...
      <div className="space-y-4">
        <Input type="text" name="Nguyễn thanh trí">
          <HiUser size={18} />
        </Input>
        ...
        <PasswordInput name="Xác nhận mật khẩu" />
        ...
        <div className="flex items-center justify-center gap-1 font-medium">
          <span className="w-full h-[1px] inline-block bg-slate-400"></span>
        ...
        <span className="flex items-center gap-0.5 text-sm w-full justify-end">
